...
%   Model Explorer > Model Workspace > edit values > re-run simulation.
    ...
    code = {
        ...
        '%   g = c_r * r_r * tau / (b * D_t)'
        '% Below u* = 1 - b/tau, gain = 0 (no timeouts, no feedback).'
    ...
    params = {'write_rate', 'read_rate', 'T_outage', 'replay_throttle', ...
              'D_total', 'D_normal', 'base_latency', 'read_timeout', 'repair_cost'};
