...
\noindent$^\dagger$Per-event only. Under sustained pressure the OOM killer fires
repeatedly (kill $\to$ restart $\to$ kill); the feedback loop that makes this
aggregate behavior dangerous is captured by level~3.
