...
permissive defaults, graceful degradation, opt-in resource limits. The
distributed systems community inherited UNIX's choice wholesale. The formal
framework presented here provides the mathematical basis for IBM's original
design: there is a computable boundary $h^*$ below which automated recovery is
provably safe and above which it is provably intractable under production load.
IBM enforced this boundary by convention; the framework shows it can be derived
from measured system parameters.
